...
feature 'User selects answer as best answer', %q{
  ...
  scenario 'Authenticated user tries to select the best answer for other users question' do
    sign_in other_user
    visit question_path question
  ...
  scenario 'The best answer is rendered first', js: true do
    ...
    expect(page.find('.answer:nth-of-type(1)')).to have_content 'Best answer'
  end
end